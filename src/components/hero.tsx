...
export default function Hero(){
    return <div className="w-full py-20 flex justify-center items-center">
        ...
        <div className="max-w-6xl flex flex-col gap-8 text-center items-center">
          <div className="flex flex-col gap-7 max-w-3xl">
          <span className="text-6xl font-bold">Zero-Effort<br/>
            AI Bookmark Manager</span>
            <p className="text-xl text-gray-700">Clipmate is an AI-first Second Brain for your Bookmarks, Screenshots, and all your other saved stuff. 
