...
export default function Integration(){
    return <div className="w-full flex flex-col justify-center items-center">
      ...
      <div className="flex flex-col text-center max-w-4xl gap-5 pb-10">
            ...
            <p className="text-gray-800 text-xs md:text-xl">Import saved items, bookmarks, screenshots and more from platforms like Twitter, Reddit, iOS Screenshots, Spotify without ever needing to switch tabs or apps.</p>
        </div>
