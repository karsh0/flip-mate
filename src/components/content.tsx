...
export default function Content(){
    ...
    <div className="flex flex-col text-center max-w-4xl gap-5 pb-10">
            ...
            <p className="text-gray-800 text-sm md:text-xl">Clipmate AI eliminates digital clutter effortlessly. It instantly organizes your bookmarks and content, with zero effort on your part. Find what you need in seconds, not hours. Think of it as your own, very smart, personal search engine.</p>
    </div>
