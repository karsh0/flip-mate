...
import Note from "../components/note";
  ...
  const notesData = [
    ...
    },
    {
      ...
      icon: <Megaphone color="rgb(245, 55, 12)" />, 
    },
    {
      title: "Entrepreneurs",
      description:
      ...
      icon: <Lightbulb color="rgb(245, 55, 12)" />, 
    },
  ];
